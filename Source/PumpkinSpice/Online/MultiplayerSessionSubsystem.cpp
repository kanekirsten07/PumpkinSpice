	...
	StartSessionCompleteDelegate(FOnStartSessionCompleteDelegate::CreateUObject(this, &UMultiplayerSessionSubsystem::OnStartSessionComplete))
{
	...
	if (OnlineSubystem)
	{
		SessionInterface = OnlineSubystem->GetSessionInterface();
	}
}
...
void UMultiplayerSessionSubsystem::CreateSession(int32 NumPublicConnections, FString MatchType)
{
	...
	{
		UE_LOG(LogOnline, Warning, TEXT("Invalid Session Interface. Unable to Create Session"));
...
void UMultiplayerSessionSubsystem::FindSessions(int MaxSearchResults)
{
	if (!SessionInterface.IsValid())
	{
		UE_LOG(LogOnline, Warning, TEXT("Invalid Session Interface"));
		return;
	}
	...
	UE_LOG(LogOnline, Log, TEXT("Finding Sessions..."));
...
#pragma region DelegateHandlers
...
#pragma endregion DelegateHandlers
