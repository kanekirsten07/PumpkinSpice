...
#include "PumpkinSpiceHUD.h"

void APumpkinSpiceHUD::DrawHUD()
{
	Super::DrawHUD();
...
void APumpkinSpiceHUD::DrawCrosshair(UTexture2D* Texture, FVector2D ViewportCenter)
{
	...
	DrawTexture(Texture, TextureDrawPoint.X, TextureDrawPoint.Y, TextureWidth, TextureHeight, 0.f, 0.f, 1.f, 1.f, FLinearColor::FromSRGBColor(FColor::Cyan));
}
